...
//     keyin7: 7
// };
// const numNew = Object.values(numbers);
// console.log(numbers);
// console.log(numNew.filter(item => item >= 3));
...
//     console.log(`New price for item is ${element.price}`);
// });
...
//     },
// ];
// const prodWithPhotos = products.filter(element => element.photos && element.photos.length > 0);
// console.log('Products with photos:', prodWithPhotos);
// const sortedProd = products.slice().sort((a, b) => a.price - b.price);
